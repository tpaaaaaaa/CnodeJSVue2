        ...
        <div class="main">
            <div class="content">
                <div class="panel">
                    ...
                    <div class="inner">
                        <div class="topic_content" v-html="topicDetail.content">
                ...
                <div class="panel">
                    ...
                    <div class="cell" v-for="(replie, index) of topicDetail.replies" :key="replie.id"
                        ...
                        <div class="reply_content" v-html="replie.content"></div>
                    </div>
                </div>
            </div>
            <div class="aside">
                <div class="panel">侧边栏1</div>
                <div class="panel">侧边栏2</div>
                <div class="panel">侧边栏3</div>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        this.$store.dispatch('getTopicById', this.id);
